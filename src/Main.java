...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Subscription subscription1 = new Subscription("Joe", "Biden", "president@gmail.com", new Reader());
        Subscription subscription2 = new Subscription("John", "Xina", "xina@gmail.com", new Reader());
        Subscription subscription3 = new Subscription("Petro", "Poroshenko", "poroh@gmail.com", new Reader());
        ...
        LibraryManager.booksTakenInitialAuthor(library, "Shevchenko");
